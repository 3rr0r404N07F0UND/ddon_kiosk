...
$(document).ready(function () {
  ...
  $(".menuPlusBtn").on("click", function (e) {
    ...
    var menuAmount = $("#".concat(e.currentTarget.parentElement.parentElement.id)).find(".menuAmount").html();
    ...
    if (menuCount < 99) {
      ...
      $("#".concat(e.currentTarget.parentElement.parentElement.id)).find(".menuAmount").html(menuAmount * (menuCount + 1));
      updateOrderTotal();
    }
